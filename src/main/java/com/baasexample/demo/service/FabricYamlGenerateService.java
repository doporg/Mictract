...
public class FabricYamlGenerateService {
    ...
    public void formJsonStorageFile(String netWorkJson,String nameSpace) throws IOException {
        String content = this.getFromYaml("src/main/resources/mid");
        content = content.replace("<content>",netWorkJson);
        File newfile = new File("src/main/resources/"+nameSpace+"-netInfo");
